// src/components/semesters/AddSemesterForm.tsx
...
import { NewSemesterSchema, type NewSemesterFormData } from '@/lib/schemas';
...
export default function AddSemesterForm({ onSubmit, onCancel, isSubmitting }: AddSemesterFormProps) {
  const form = useForm<NewSemesterFormData>({
    ...
    defaultValues: {
      ...
      add_drop_start_date: undefined,
      add_drop_end_date: undefined,
    },
  });
